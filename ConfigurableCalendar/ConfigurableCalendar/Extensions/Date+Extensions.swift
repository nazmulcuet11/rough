...
public enum DateFormatType {
    ...
    /// a short date format "dd MMM yy" i.e. 13 Oct 18
    case shortDate

    /// a short date format "dd MMM yyyy" i.e. 13 Oct 2020
    ...
    var stringFormat:String {
        switch self {
            ...
            case .shortDate: return "dd MMM yy"
            case .shortDateFullYear: return "dd MMM yyyy"
